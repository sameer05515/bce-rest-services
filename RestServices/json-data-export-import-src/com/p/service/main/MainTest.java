...
import com.p.service.action.TopicAction;
...
import com.p.service.util.NoActionsProvidedException;
import com.p.service.util.RequiredActionMissingException;
...
public class MainTest {
	...
	public static void main(String[] args)
		...
		Action[] acts = { Action.FIND_CONFLICTS, Action.READ_FROM_SOURCE };
		...
		// createAndConsumeTopicGroupRelationJSON(jsonDataDirectory +
		// "topic-group-data.json", acts);
		// createAndConsumeGroupViewRelationJSON(jsonDataDirectory +
		// "group-view-data.json", acts);
		// createAndConsumeViewTopicRelationJSON(jsonDataDirectory +
		// "view-topics-data.json", acts);
	}
	...
	private static void createAndConsumeTopicJSON(String filePath, Action... actions)
		...
		// System.out.println("Provide action what to do ? Create or
		// Consume??");
		// }
		//
